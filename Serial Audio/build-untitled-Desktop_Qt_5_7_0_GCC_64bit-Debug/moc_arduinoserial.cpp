...
#include "../untitled/arduinoserial.h"
...
void ArduinoSerial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ArduinoSerial *_t = static_cast<ArduinoSerial *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ArduinoSerial::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ArduinoSerial.data,
      qt_meta_data_ArduinoSerial,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ArduinoSerial::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ArduinoSerial.stringdata0))
        return static_cast<void*>(const_cast< ArduinoSerial*>(this));
